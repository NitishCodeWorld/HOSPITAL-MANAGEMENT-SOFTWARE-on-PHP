                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <td><input type="text" name="f-name" placeholder="First name" require></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-12 col-md-4">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <td><input type="text" name="p-id" placeholder="Enter Patient id" require></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-12 col-md-4">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="col-12 col-md-4">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="phone" id="phone-number" placeholder="Phone number" require>
                                </td>
                            </tr>
                        </table>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <select>
                                        ...
                                        <option value="doctor">Binay Kumar</option>
                                        <option value="doctor">Nidhi Jha</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
